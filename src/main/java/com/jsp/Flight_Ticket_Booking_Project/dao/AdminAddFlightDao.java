   ...
   public List<AdminAddFlight> getAllFlightDetails()
   {
	   ...
	   try {
		...
		while(resultSet.next())
		{
			...
			addFlight.setDepartureTime(resultSet.getTime("departureTime"));
			addFlight.setArrivalTime(resultSet.getTime("arrivalTime"));
			addFlight.setFlightEconomicPrice(resultSet.getDouble("flightEconomicPrice"));
