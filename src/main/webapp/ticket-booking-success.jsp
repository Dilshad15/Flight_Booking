...
<body>
   ...
   <%
        ...
        String userFlight=(String)request.getAttribute("userBookFlight");
   %>
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-4-strong card-registration" style="border-radius: 10px;">
          <div class="card-body p-4 p-md-4">
            <h3 class="mb-4 pb-4 pb-md-0 mb-md-4 align-items-center h-100 text-center">Booking Status</h3>
            
            
            <%if(userFlight!=null) {%>
                <h6 style="color:green"><%=userFlight %></h6>
